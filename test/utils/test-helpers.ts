...
export const commonDenoArgs = [
  "--allow-env=GITHUB_*,GH_*,LINEAR_*,NODE_ENV,EDITOR,SNAPSHOT_TEST_NAME,MOCK_GIT_BRANCH_COMMAND,TEST_CURRENT_TIME,CLIFFY_SNAPSHOT_FAKE_TIME,XDG_CONFIG_HOME,HOME,APPDATA",
  "--allow-read",
  "--allow-write",
  "--allow-run",
  "--allow-net",
